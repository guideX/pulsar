...
namespace Pulsar.Environment
{
    class GlobalEnvironment
    {
        ...
        public GlobalEnvironment(Pulsar.Security.Account acc)
        {
            _Variables.Add(new EnvVariable("HOST", "Pulsar"));
        ...
        public static void Init(Pulsar.Security.Account acc)
        {
