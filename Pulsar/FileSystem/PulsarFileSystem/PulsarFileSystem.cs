...
namespace Pulsar.FileSystem.PulsarFileSystem {
    class PulsarFileSystem : Fs.FileSystem {
        ...
        public static PulsarFileSystem mFS = null;
        public static String separator = "/";
        public static void ClearBlocks(PulsarFSBlock StartBlock) {
            PulsarFSBlock b = StartBlock;
            while(b.NextBlock != 0) {
                b = PulsarFSBlock.Read(b.Partition, b.NextBlock);
                b.Used = false;
                PulsarFSBlock.Write(mFS.Partition, b);
            }
        }
        public static void AddMapping(string aPath, PulsarFileSystem aFileSystem) {
            mFS = aFileSystem;
        }
